<%-- 
    Document   : facsignup
    Created on : Mar 14, 2014, 5:49:42 PM
    Author     : eNVious
--%>
...
<tr>  <td><table align="center" cellpadding=0 cellspacing=0 border=0 width=100%>   
            <tr>   <td align="center" style="padding:2;padding-bottom:4">  <font size="5"><b>Student Sign Up</b></font></tr>
...
String phno=request.getParameter("phno");
	...
	try{
			...
			String sql="insert into studentsignup values('"+username+"','"+pas+"','"+name+"','"+phno+"','"+subject+"','"+branch+"' )"; 
