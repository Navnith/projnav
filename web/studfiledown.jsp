<%-- 
    Document   : studfiledown
    Created on : Mar 23, 2014, 1:09:32 PM
    Author     : eNVious
--%>
...
<li  class="active"><a href="studfiledown.jsp" title="Download Files">Download PPT/Video</a> </li>
...
<form action="studfiledown.jsp" method="post" >
...
try{
		...
		Connection c1= DriverManager.getConnection("jdbc:mysql://localhost:3306/virclass","root","envious");
