<%-- 
    Document   : faclogin
    Created on : Mar 8, 2014, 9:49:54 PM
    Author     : eNVious
--%>
...
<link rel="stylesheet" type="text/css" href="helvetica.css">
 <nav>
            <ul>
                ...
                <li class="active"><a href="faclogin.jsp">Faculty Login</a></li>
   ...
   <TD> 
	<table cellpadding=2 cellspacing=0 border=0> 
                    ...
                    <tr>   <td bgcolor="white" align="center" style="padding:2px;padding-bottom:4px">  
                            <b><font size=7 color="#ccc" face="Corbel">FACULTY LOGIN</font></b></tr> 
	<tr><td bgcolor="white">
		...
		<tr><td colspan=2>Lost your username or password? Find it <a href="#">here</a>!</td></tr>
                <tr><td colspan=2>Not member yet? Click <a href="fsignup.jsp">HERE</a> to register.</font></td></tr>
